      ...
      switch (props.color) {
        ...
        case 'green': {
          return [
            ...
            'dark:hover:enabled:bg-green-400',
            'text-white',
            'hover:enabled:shadow-lg',
            'hover:enabled:shadow-green-500/50',
            'dark:hover:enabled:shadow-green-800/20',
            'focus-visible:outline-green-400/70',
            'focus-within:outline-green-400/70',
            'focus-visible:bg-green-500',
            'active:enabled:bg-green-500',
            'dark:focus-visible:outline-green-400/70',
            'dark:focus-within:outline-green-400/70',
            'dark:focus-visible:bg-green-500',
            'dark:active:enabled:bg-green-500',
          ]
        }
        case 'red': {
          return [
            ...
            'dark:hover:enabled:bg-red-400',
            'text-white',
            'hover:enabled:shadow-lg',
            'hover:enabled:shadow-red-500/50',
            'dark:hover:enabled:shadow-red-800/20',
            'focus-visible:outline-red-400/70',
            'focus-within:outline-red-400/70',
            'focus-visible:bg-red-500',
            'active:enabled:bg-red-500',
            'dark:focus-visible:outline-red-400/70',
            'dark:focus-within:outline-red-400/70',
            'dark:focus-visible:bg-red-500',
            'dark:active:enabled:bg-red-500',
          ]
        }
        case 'warning': {
          return [
      ...
      switch (props.color) {
        ...
        case 'green': {
          return [
            ...
            'dark:bg-transparent',
            'dark:text-green-500',
            'dark:hover:enabled:bg-green-500/10',
            'focus-visible:outline-green-400/70',
            'focus-within:outline-green-400/70',
            'focus-visible:bg-green-200',
            'active:enabled:bg-green-100',
            'dark:focus-visible:outline-green-400/70',
            'dark:focus-within:outline-green-400/70',
            'dark:focus-visible:bg-green-500/10',
            'dark:active:enabled:bg-transparent',
          ]
        }
        case 'red': {
          return [
            ...
            'dark:bg-transparent',
            'dark:text-red-500',
            'dark:hover:enabled:bg-red-500/10',
            'focus-visible:outline-red-400/70',
            'focus-within:outline-red-400/70',
            ...
            'dark:focus-visible:outline-red-400/70',
            'dark:focus-within:outline-red-400/70',
            'dark:focus-visible:bg-red-500/10',
            'dark:active:enabled:bg-transparent',
          ]
        }
        case 'warning': {
      ...
      switch (props.color) {
        ...
        case 'green': {
          return [
            ...
            'border-2',
            'border-green-500',
            'hover:enabled:bg-green-500',
            'focus-within:outline-green-400/70',
            'focus-visible:outline-green-400/70',
            'focus-visible:bg-green-500',
            'focus-visible:text-white',
            'active:enabled:text-white',
            'active:enabled:bg-green-400',
          ]
        }
        case 'red': {
          return [
...
const shadowClasses = computed(() => {
  if (props.flavor === 'solid' && props.shadow === 'flat') {
    switch (props.color) {
      ...
      case 'green': {
        return ['!shadow-xl !shadow-green-500/30 dark:!shadow-green-500/20']
      }
      case 'red': {
        return ['!shadow-xl !shadow-red-500/30 dark:!shadow-red-500/20']
      }
    ...
    switch (props.color) {
      ...
      case 'green': {
        return [
          'hover:!shadow-xl hover:!shadow-green-500/30 dark:hover:!shadow-green-500/20',
        ]
      }
      case 'warning': {
        return [
      ...
      case 'red': {
        return [
          'hover:!shadow-xl hover:!shadow-red-500/30 dark:hover:!shadow-red-500/20',
        ]
      }
      default: {
        return ['']
...
const buttonClasses = computed(() => [
  ...
  props.isSquare ? 'is-button-squared' : '',
...
.is-button-squared {
  @apply relative font-sans font-normal text-sm no-underline inline-flex justify-center items-center leading-5 h-32 px-5 py-2 space-x-1 nui-focus transition-all duration-300 disabled:opacity-60 disabled:cursor-not-allowed hover:shadow-none;
}
.is-button-default {
