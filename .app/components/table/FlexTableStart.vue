...
<template>
  ...
  >
    ...
    <BaseAvatar
      v-if="
        (props.avatar && !props.icon && !props.picture && !props.logo) ||
        (props.initials && !props.icon && !props.picture && !props.logo)
      "
      :src="props.avatar"
    ...
    />
    <BaseIconBox
      v-else-if="props.icon && !props.avatar && !props.picture && !props.logo"
      :icon="props.icon"
      size="sm"
      class="bg-primary-500/20 text-primary-500"
    >
    ...
    <div
      v-else-if="props.picture && !props.avatar && !props.icon && !props.logo"
    ...
    <div
      v-else-if="props.logo && !props.picture && !props.avatar && !props.icon"
      class="relative shrink-0"
    >
      <img
        loading="lazy"
