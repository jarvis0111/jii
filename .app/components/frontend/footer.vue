...
const socialLinks = computed(() => settingsStore.settings?.social_links)
</script>

<template>
  <footer class="p-4 bg-gray-950 sm:p-6 dark:bg-gray-950">
    <div class="mx-auto max-w-screen-xl pt-8">
      <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0 z-50">
          ...
          <p class="text-sm text-gray-500 dark:text-gray-400 max-w-xl">
            Our exchange uses charting technology provided by TradingView, a
            global platform where you can
            <a
              ...
              >watch cryptocurrency prices</a
            >, analyze market movements, and prepare for trades with the latest
            news and insights from fellow traders.
          </p>
        </div>
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2 z-50">
          <div>
            <h2
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0 z-50">
          <a
