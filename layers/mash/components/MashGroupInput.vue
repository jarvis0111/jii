  ...
  <div class="relative" :class="props.classes?.wrapper">
    ...
    <div class="group/nui-input relative">
      ...
      <div
        ...
        class="text-muted-400 absolute end-3 top-0 flex items-center justify-center text-sm transition-colors duration-300 peer-disabled:cursor-not-allowed peer-disabled:opacity-75"
        :class="[
          props.condensed && 'h-8 w-8',
          !props.condensed && 'h-10 w-10',
          props.loading && 'opacity-0',
